...
import PNG_MtechLogo from "@/assets/images/PNG_MtechLogo.png";
            ...
            <div className="container flex mx-auto justify-between items-center">
                ...
                <div className="flex flex-grow ml-10 items-center">
                    <Image
                        ...
                        height={20}
                    />
                    <h1 className="text-2xl text-black font-bold ml-6">
                        MabuhayTech System
                    </h1>
                </div>
                <nav>
                    <ul className="flex space-x-4 items-center">
                        ...
                        <li>
                            <a
                                href="#features"
                                className="text-black items-center hover:text-blue-500"
                            >
                                {username}
                            </a>
                        </li>
